...
const DeckModal = forwardRef<DeckModalHandle, DeckModalProps>(
  ({ onSave, onDelete }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      present: (deck?: Deck) => {
        if (deck) {
          ...
          const deckColor =
            DeckColors.find(
              (c) => (colorScheme === "dark" ? c.dark : c.light) === deck.color
            ) || DeckColors[0];
    ...
    const handleSave = async () => {
      ...
      const deckData: Deck = {
        ...
        color:
          colorScheme === "dark" ? selectedColor.dark : selectedColor.light,
